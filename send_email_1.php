...
<?php
	...
	$to = "badrul.sajib@gmail.com";/* YOUR EMAIL HERE */
	$subject = "Job application from Potenza";
	$headers = "From: Job application from SteadFast <noreply@yourdomain.com>";
...
<div id="success">
	...
	<small>You will be redirect to main page in 5 seconds.</small>
</div>
</body>
</html>